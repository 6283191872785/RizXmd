...
const axios = require('axios'); // Jika menggunakan Node.js

const getNewsletterMetadata = async (id) => {
    const response = await axios.get(`https://api.example.com/newsletter/${id}/metadata`);
    return response.data;
};

const followNewsletter = async (id) => {
    const response = await axios.post(`https://api.example.com/newsletter/${id}/follow`);
    return response.data;
};
